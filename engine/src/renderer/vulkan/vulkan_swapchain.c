...
// submits the rendered image to the presentation queue
void vulkan_swapchain_present(
    ...
    // struct for how image should be presented 
...
void create(vulkan_context* context, u32 width, u32 height, vulkan_swapchain* swapchain) {
    ...
    //try using mail box mode triple buffering
    ...
    // Vulkan doesn't let you directly use VkImage for rendering. 
    // Views:describe how to access an image (e.g., color, depth, etc.).
